...
exports.RINGER_MODE = exports.Mode = exports.AVAudioSessionRouteSharingPolicy = exports.AVAudioSessionMode = exports.AVAudioSessionCategoryOptions = exports.AVAudioSessionCategory = void 0;
/**
 ...
 */
let AVAudioSessionCategory = exports.AVAudioSessionCategory = /*#__PURE__*/function (AVAudioSessionCategory) {
  /**
   ...
   *
   */
  AVAudioSessionCategory["Ambient"] = "Ambient";
  /**
   ...
   * AllowBluetoothA2DP
   */
  AVAudioSessionCategory["SoloAmbient"] = "SoloAmbient";
  /**
   ...
   */
  AVAudioSessionCategory["Playback"] = "Playback";
  /**
   ...
   * MixWithOthers, DuckOthers, InterruptSpokenAudioAndMixWithOthers, AllowBluetoothA2DP
   */
  AVAudioSessionCategory["Record"] = "Record";
  /**
   ...
   *
   */
  AVAudioSessionCategory["MultiRoute"] = "MultiRoute";
  return AVAudioSessionCategory;
}({});
/**
...
let AVAudioSessionMode = exports.AVAudioSessionMode = /*#__PURE__*/function (AVAudioSessionMode) {
  /**
   ...
   */
  AVAudioSessionMode["VoiceChat"] = "VoiceChat";
  /**
   ...
   * If an app uses the Voice-Processing I/O audio unit and hasn’t set its mode to one of the chat modes (voice, video, or game), the session sets the voiceChat mode implicitly. On the other hand, if the app had previously set its category to playAndRecord and its mode to videoChat or gameChat, instantiating the Voice-Processing I/O audio unit doesn’t cause the mode to change.
   */
  AVAudioSessionMode["VideoChat"] = "VideoChat";
  /**
   ...
   */
  AVAudioSessionMode["GameChat"] = "GameChat";
  /**
   ...
   */
  AVAudioSessionMode["VideoRecording"] = "VideoRecording";
  /**
   ...
   */
  AVAudioSessionMode["MoviePlayback"] = "MoviePlayback";
  /**
   ...
   */
  AVAudioSessionMode["SpokenAudio"] = "SpokenAudio";
  /**
   ...
   */
  AVAudioSessionMode["VoicePrompt"] = "VoicePrompt";
 ...
 */
// export type AVAudioSessionCategory = typeof AVAudioSessionCategory[keyof typeof AVAudioSessionCategoryMap];
let AVAudioSessionRouteSharingPolicy = exports.AVAudioSessionRouteSharingPolicy = /*#__PURE__*/function (AVAudioSessionRouteSharingPolicy) {
  /**
   * A policy that follows standard rules for routing audio output.
   */
  AVAudioSessionRouteSharingPolicy["Default"] = "Default";
  /**
   ...
   */
  AVAudioSessionRouteSharingPolicy["LongFormAudio"] = "LongFormAudio";
  /**
   ...
   */
  AVAudioSessionRouteSharingPolicy["LongFormVideo"] = "LongFormVideo";
  /**
   ...
   */
  AVAudioSessionRouteSharingPolicy["Independent"] = "Independent";
  return AVAudioSessionRouteSharingPolicy;
}({});
/**
 * Route Sharing Policies for AV Audio Sessions.
 * Refer to Apple Docs: https://developer.apple.com/documentation/avfaudio/avaudiosession/routesharingpolicy-swift.enum
 */
// export type AVAudioSessionCategory = typeof AVAudioSessionCategory[keyof typeof AVAudioSessionCategoryMap];
let AVAudioSessionCategoryOptions = exports.AVAudioSessionCategoryOptions = /*#__PURE__*/function (AVAudioSessionCategoryOptions) {
  /**
   ...
   */
  AVAudioSessionCategoryOptions["MixWithOthers"] = "MixWithOthers";
  /**
   ...
   */
  AVAudioSessionCategoryOptions["DuckOthers"] = "DuckOthers";
  /**
   ...
   */
  AVAudioSessionCategoryOptions["InterruptSpokenAudioAndMixWithOthers"] = "InterruptSpokenAudioAndMixWithOthers";
  /**
   ...
   */
  AVAudioSessionCategoryOptions["AllowAirPlay"] = "AllowAirPlay";
  /**
   ...
   */
  AVAudioSessionCategoryOptions["OverrideMutedMicrophoneInterruption"] = "OverrideMutedMicrophoneInterruption";
  return AVAudioSessionCategoryOptions;
}({});
/**
...
const RINGER_MODE = exports.RINGER_MODE = {
  silent: 0,
  vibrate: 1,
  normal: 2
};
