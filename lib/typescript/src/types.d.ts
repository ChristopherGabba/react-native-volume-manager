...
export declare enum AVAudioSessionCategory {
    /**
 ...
 */
export declare enum AVAudioSessionMode {
    /**
 ...
 */
export declare enum AVAudioSessionRouteSharingPolicy {
    /**
 ...
 * Refer to Apple Docs: https://developer.apple.com/documentation/avfaudio/avaudiosession/routesharingpolicy-swift.enum
 */
export declare enum AVAudioSessionCategoryOptions {
    /**
...
export type AVAudioSessionCompatibleModes = {
    ...
    Playback: AVAudioSessionMode.Default | AVAudioSessionMode.MoviePlayback | AVAudioSessionMode.SpokenAudio | AVAudioSessionMode.Measurement;
    Record: AVAudioSessionMode.Default | AVAudioSessionMode.VideoRecording | AVAudioSessionMode.VideoChat | AVAudioSessionMode.Measurement | AVAudioSessionMode.SpokenAudio;
    PlayAndRecord: AVAudioSessionMode.Default | AVAudioSessionMode.Measurement | AVAudioSessionMode.SpokenAudio | AVAudioSessionMode.VoiceChat | AVAudioSessionMode.VideoChat | AVAudioSessionMode.GameChat | AVAudioSessionMode.VideoRecording;
...
export type AVAudioSessionCompatibleCategoryOptions = {
    Ambient: AVAudioSessionCategoryOptions.MixWithOthers | AVAudioSessionCategoryOptions.AllowBluetoothA2DP;
    SoloAmbient: AVAudioSessionCategoryOptions.AllowBluetoothA2DP;
    Playback: AVAudioSessionCategoryOptions.MixWithOthers | AVAudioSessionCategoryOptions.DuckOthers | AVAudioSessionCategoryOptions.InterruptSpokenAudioAndMixWithOthers | AVAudioSessionCategoryOptions.AllowBluetoothA2DP;
    Record: AVAudioSessionCategoryOptions.AllowBluetooth;
    PlayAndRecord: AVAudioSessionCategoryOptions.MixWithOthers | AVAudioSessionCategoryOptions.DuckOthers | AVAudioSessionCategoryOptions.InterruptSpokenAudioAndMixWithOthers | AVAudioSessionCategoryOptions.AllowBluetooth | AVAudioSessionCategoryOptions.AllowBluetoothA2DP | AVAudioSessionCategoryOptions.AllowAirPlay | AVAudioSessionCategoryOptions.DefaultToSpeaker | AVAudioSessionCategoryOptions.OverrideMutedMicrophoneInterruption;
    MultiRoute: AVAudioSessionCategoryOptions.MixWithOthers | AVAudioSessionCategoryOptions.DuckOthers | AVAudioSessionCategoryOptions.InterruptSpokenAudioAndMixWithOthers;
};
